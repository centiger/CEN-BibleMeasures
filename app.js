const C = {
  length: {
    icon:"📏", title:"길이", desc:"규빗·뼘·리 등 성경의 길이를 현대 길이로 환산합니다.", out:"m", modernLabel:"현대 길이(m)", def:[300,"cubit"],
    units:[
  ...
  weight: {
    icon:"⚖️", title:"무게", desc:"게라·세겔·달란트 등 성경의 무게를 현대 무게로 환산합니다.", out:"kg", modernLabel:"현대 무게(kg)", def:[600,"shekel"],
    units:[
  ...
  volume: {
    icon:"🫙", title:"부피", desc:"에바·밧·고르 등 성경의 부피를 현대 부피로 환산합니다.", out:"L", modernLabel:"현대 부피(L)", def:[1,"ephah"],
    units:[
      ["hin","힌",3.7,"1힌 ≈ 3.7L"],
      ["bath","밧",22,"1밧 ≈ 22L"],
      ["ephah","에바",22,"1에바 ≈ 22L"],
  ...
  money: {
    icon:"💰", title:"화폐", desc:"드라크마·데나리온 등 성경의 화폐를 원화 감각으로 환산합니다.", out:"원", modernLabel:"현대 화폐(원)", def:[1,"denarius"],
    units:[
  ...
  time: {
    icon:"⏰", title:"시간", desc:"제3시·제6시·제9시를 오늘 시간 감각으로 환산합니다.", out:"시", modernLabel:"현대 시간", def:[6,"jewish"],
