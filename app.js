const C = {
  length: {
    icon:"📏", title:"길이", desc:"규빗·뼘·손바닥·장대·리를 m로 바꿉니다.", out:"m", def:[1,"ri"],
    units:[["cubit","규빗",0.45,"1규빗 ≈ 45cm"],["span","뼘",0.225,"1뼘 ≈ 22.5cm"],["hand","손바닥",0.075,"1손바닥 ≈ 7.5cm"],["reed","장대",3.15,"1장대 ≈ 3.15m"],["ri","리",1480,"성경의 ‘리’는 로마식 1마일 체감으로 약 1.48km"]],
    feel:v=>[`⚽ 축구장 길이 약 ${(v/105).toFixed(1)}개`,`🚍 버스 약 ${(v/11).toFixed(1)}대 길이`,v>=30?`🏢 약 ${Math.round(v/3)}층 건물 높이와 비슷`:`🧍 사람 키와 비교 가능한 길이`],
    bible:["노아의 방주: 길이 300규빗","성막 뜰: 길이 100규빗, 너비 50규빗","솔로몬 성전: 길이 60규빗","오 리를 가게 하거든 십 리를 동행하라"]
  },
  weight: {
    icon:"⚖️", title:"무게", desc:"게라·세겔·므나·달란트를 kg으로 바꿉니다.", out:"kg", def:[1,"gerah"],
    units:[["gerah","게라",0.00057,"1게라 ≈ 0.57g, 1세겔의 1/20"],["shekel","세겔",0.0114,"1세겔 ≈ 11.4g"],["mina","므나",0.57,"1므나 ≈ 0.57kg"],["talent","달란트",34.2,"1달란트 ≈ 34.2kg"]],
    feel:v=>[v>=6?"🎳 볼링공 1개와 비슷하거나 더 무거움":"🍎 사과 몇 개 정도의 무게",`🎒 가방 ${(v/3).toFixed(1)}개 정도`,v>=30?"🏋️ 성인도 들기 부담스러운 무게":"손으로 들 수 있는 무게"],
    bible:["게라: 성소의 세겔을 설명할 때 등장하는 작은 무게 단위","골리앗의 창날: 철 600세겔","성막과 성전 재료 계산에 사용","달란트: 금·은 같은 큰 무게 단위"]
  },
  volume: {
    icon:"🫙", title:"부피", desc:"힌·밧·에바·고르·호멜을 L로 바꿉니다.", out:"L", def:[1,"kor"],
    units:[["hin","힌",3.7,"1힌 ≈ 3.7L"],["bath","밧",22,"1밧 ≈ 22L"],["ephah","에바",22,"1에바 ≈ 22L"],["kor","고르",220,"1고르 ≈ 220L, 호멜과 비슷한 큰 부피 단위"],["homer","호멜",220,"1호멜 ≈ 220L"]],
  ...
  money: {
    icon:"💰", title:"화폐", desc:"렙돈·드라크마·데나리온·세겔·달란트를 원화 체감으로 바꿉니다.", out:"원", def:[1,"drachma"],
    units:[["lepton","렙돈",500,"2렙돈은 매우 작은 돈"],["drachma","드라크마",100000,"체감용: 1드라크마 ≈ 하루 품삯에 가까운 은화"],["denarius","데나리온",100000,"1데나리온 ≈ 노동자 하루 품삯"],["silver","은 세겔",120000,"체감용: 은 1세겔 ≈ 10만 원대"],["talent","달란트",700000000,"체감용: 1달란트 ≈ 수억 원대"]],
